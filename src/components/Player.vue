<template>
  <div class="player">
    <div class="content">
      ...
      <div class="top">
        <span 
          class="iconfont down icon-zhcc_xiangxiajiantou"
          @click="handleBack"
        ></span>
        <ul>
          <li>推荐</li>
        ...
        <div class="share">
          ...
          <span class="iconfont icon-fenxiang" @click="showPopShare"></span>
        </div>
      </div>
      ...
      <div class="conbox">
        ...
        <!-- 专辑图片 -->
        <div class="img">
          <img :class="['cd',isPlay?'':'paused']" :src="`https://y.gtimg.cn/music/photo_new/T002R300x300M000${song.album.mid}.jpg`" alt="">
        </div>
        ...
        <!-- 歌词 -->
        <lyric :songmid="song.mid" :seektime="starttime"/>
